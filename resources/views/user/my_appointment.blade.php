      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span>999</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> rabialhasan@gmail.com</a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="5cm\Internet programming\5cm\hospital1\storage\portfolio\index.html">About Us</a>
            </li>
            <li class="nav-item">
            ...
            @auth
            <li class="nav-item">
              <a class="nav-link" style="background-color:skyblue; border-radius: 25px;" href="{{url('myappointment')}}">My Appointment</a>
            </li>
            <x-app-layout>
